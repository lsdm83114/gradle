...
public class DefaultTypeValidationContext extends ProblemRecordingTypeValidationContext {
    ...
    public static final ProblemId MISSING_NORMALIZATION_ID = DefaultProblemId.from("missing-normalization-annotation", "Missing normalization", GradleCoreProblemGroup.TYPE_VALIDATION);
